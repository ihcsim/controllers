...
import (
	...
	"github.com/ihcsim/controllers/crd/typed/pkg/generated/clientset/versioned/scheme"
...
// AppV1alpha1Client is used to interact with features provided by the app.example.com group.
type AppV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AppV1alpha1Client) Databases(namespace string) DatabaseInterface {
