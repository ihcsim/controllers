...
import (
	...
	scheme "github.com/ihcsim/controllers/crd/typed/pkg/generated/clientset/versioned/scheme"
...
func newDatabases(c *AppV1alpha1Client, namespace string) *databases {
	return &databases{
		client: c.RESTClient(),
		ns:     namespace,
	}
