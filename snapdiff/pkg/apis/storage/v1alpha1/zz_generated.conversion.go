...
func autoConvert_v1alpha1_ChangedBlockList_To_storage_ChangedBlockList(in *ChangedBlockList, out *storage.ChangedBlockList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]storage.ChangedBlock, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_ChangedBlock_To_storage_ChangedBlock(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_storage_ChangedBlockList_To_v1alpha1_ChangedBlockList(in *storage.ChangedBlockList, out *ChangedBlockList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]ChangedBlock, len(*in))
		for i := range *in {
			if err := Convert_storage_ChangedBlock_To_v1alpha1_ChangedBlock(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha1_ChangedBlockSpec_To_storage_ChangedBlockSpec(in *ChangedBlockSpec, out *storage.ChangedBlockSpec, s conversion.Scope) error {
	// WARNING: in.Offset requires manual conversion: does not exist in peer-type
	// WARNING: in.Size requires manual conversion: does not exist in peer-type
	// WARNING: in.Context requires manual conversion: does not exist in peer-type
	// WARNING: in.ZeroOut requires manual conversion: does not exist in peer-type
	return nil
}
...
func autoConvert_storage_ChangedBlockSpec_To_v1alpha1_ChangedBlockSpec(in *storage.ChangedBlockSpec, out *ChangedBlockSpec, s conversion.Scope) error {
	// WARNING: in.SnapshotBase requires manual conversion: does not exist in peer-type
	// WARNING: in.SnapshotTarget requires manual conversion: does not exist in peer-type
	// WARNING: in.VolumeID requires manual conversion: does not exist in peer-type
	// WARNING: in.Secrets requires manual conversion: does not exist in peer-type
	// WARNING: in.Parameters requires manual conversion: does not exist in peer-type
	return nil
}
