...
import (
	...
	"github.com/ihcsim/controllers/snapdiff/pkg/generated/clientset/versioned/scheme"
...
// StorageV1alpha1Client is used to interact with features provided by the storage.isim.dev group.
type StorageV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StorageV1alpha1Client) ChangedBlocks(namespace string) ChangedBlockInterface {
